...
def test_constants_real_universe():
...
def test_constants_degeneracy_pair():
    with TestClient(app) as client:
...
def test_constants_rejects_out_of_range():
    with TestClient(app) as client:
...
def test_classical_hydrogen_collapse():
    with TestClient(app) as client:
...
def test_classical_rejects_bad_n():
    with TestClient(app) as client:
