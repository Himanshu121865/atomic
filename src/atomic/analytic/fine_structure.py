...
estimate. The refinement it points at is the exact Dirac-Coulomb solution,
delivered in analytic/dirac.py. See docs/specs/phase7-fine-structure.md.
"""
...
def fine_structure_shift(
    ...
    argument is the seam the constants lab's `FundamentalConstants.alpha`
    supplies, so no signature change will be needed then.
    """
